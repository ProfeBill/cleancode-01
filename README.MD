...
```
py src/view/CreditCardConsole.py
```
...
- Carpeta src: Codigo fuente de la logica de la aplicación. Tiene subcarpetas por cada capa de la aplicacion: model, view, controller
- Carpeta tests: Pruebas Unitarias 
- Capeta docs: Documentación adicional
